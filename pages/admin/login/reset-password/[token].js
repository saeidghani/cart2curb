...
const ResetPassword = props => {
    ...
    const loading = useSelector(state => state?.loading?.effects?.adminAuth?.resetPassword);
    ...
    const breadcrumb = [
        ...
        },
        {
            ...
            href: routes.admin.auth.forgetPassword,
        },
        {
    ...
    const submitHandler = async (values) => {
        ...
        const res = await dispatch?.adminAuth?.resetPassword(body)
        if(res) {
            setSubmitted(true);
        }
    }
