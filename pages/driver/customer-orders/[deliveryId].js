...
const CurrentOrders = () => {
    ...
    useEffect(() => {
        customerOrders?.products?.forEach(p => {
         setCurrentQuantity({[p._id]: p?.quantity})
        });
    }, [customerOrders]);
                    ...
                    {(customerOrders?.products || [])?.map(product =>
                            <div className="flex flex-col">
                                <div className="flex items-center space-x-2 p-4"
                                    ...
                                    <img
                                        src={product?.productExtraInfo?.images?.length > 0 ? product?.productExtraInfo?.images[0] : ''}
                                        alt="" width={56}/>
                                ...
                                <div className="flex items-center">
                                    ...
                                    <div className="flex items-center space-x-4 pt-4">
                                        ...
                                        >
                                        <span className="text-lg absolute top-0 left-0" style={{paddingTop: 8, paddingLeft: 7}}>
                                        ...
                                        >
                                        <span className="text-lg absolute top-0 left-0" style={{paddingTop: 4, paddingLeft: 7}}>
                                            <svg width="10" height="10" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M4.58984 0.078125H5.41016C5.48307 0.078125 5.51953 0.114583 5.51953 0.1875V9.8125C5.51953 9.88542 5.48307 9.92188 5.41016 9.92188H4.58984C4.51693 9.92188 4.48047 9.88542 4.48047 9.8125V0.1875C4.48047 0.114583 4.51693 0.078125 4.58984 0.078125Z" fill="black"/>
                                            <path d="M0.40625 4.48047H9.59375C9.66667 4.48047 9.70312 4.51693 9.70312 4.58984V5.41016C9.70312 5.48307 9.66667 5.51953 9.59375 5.51953H0.40625C0.333333 5.51953 0.296875 5.48307 0.296875 5.41016V4.58984C0.296875 4.51693 0.333333 4.48047 0.40625 4.48047Z" fill="black"/>
                                            </svg>
                                        </span>
                                        </div>
                                    </div>
